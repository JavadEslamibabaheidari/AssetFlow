...
M7, Event-Driven Synchronization, is complete pending final release closure. Its plan is `docs/plans/m7-event-driven-synchronization.md`, its report is `docs/milestone-7-report.md`, and its GitHub tracking is issues #85 through #90 under the `M7 - Event-Driven Synchronization` milestone. Implementation PRs #91 through #95 are merged; issue #90 owns final docs, tag, release, and milestone closure.
